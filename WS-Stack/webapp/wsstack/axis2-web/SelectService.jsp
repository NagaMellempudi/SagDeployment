...
<jsp:include page="include/adminheader.jsp"></jsp:include>
  ...
  <%
      ...
      if(status != null && status.equals("MODULE")) {
          ...
          disc = "Select a Web Services Stack service from the combo and click on the 'View Operations' button to view operation specific Chains.";
      } else if(status != null && status.equals("VIEW")){
          buttonName = " View ";
          action = "viewServiceHandlers";
          heading = "Select a service to view service handlers";
          disc = "Select a Web Services Stack service from the combo and click on the 'View' button to view service handlers.";
          ...
          disc = "Select a Web Services Stack service from the combo and click on the 'Edit Parameters' button to edit parameters.";
      }
  %>
<h1><%=heading%></h1>
<p><%=disc%></p>
