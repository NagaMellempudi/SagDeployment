...
:okHome
rem set the classes
rem Classpath must be hardcoded. for loop is not a solution - it generates too
rem long command line
setlocal EnableDelayedExpansion
set AXIS2_CLASS_PATH=%AXIS2_HOME%\lib\wsstack-server-10.5.0.0.jar
